    ...
    def afficherpartie(self,mod):
        ...
        for proj in mod.projectiles:
            if isinstance(proj, RondRouge):
                ...
                #self.canevas.create_oval((proj.x-proj.taille)*e,(proj.y-proj.taille)*e, (proj.x+proj.taille)*e,(proj.y+proj.taille)*e, fill = "blue", tag=("projectile",))
                self.canevas.create_image((proj.x-proj.taille)*e,(proj.y-proj.taille)*e, image = self.vue.images["trounoir"],tags=("projectile",))
